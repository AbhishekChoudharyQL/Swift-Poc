...
struct SignUpView: View {
    ...
    //MARK: - Properties
    @State var userNameText : String = "Test"
    @State var emailText : String = "test@gmail.com"
    @State var passwordText : String = "123456789"
  ...
  ZStack(content: {
    VStack(content: {
        ...
        VStack(spacing: 15, content: {
            ...
            CustomSecureField(imageName: SignUpData.passwordImage.rawValue, placeholderText: SignUpData.passwordPlaceholder.rawValue, inputString: passwordText)
        })
        VStack(content: {
